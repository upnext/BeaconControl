...
BeaconControl::AnalyticsExtension.configure do |config|
  #
  ...
  #   i18n_key: 'activities.form.scheme.analytics',
  #   scheme: 'analytics',
  #   permitted_attributes: { analytics_attributes: [:id, :name, :_destroy] }
  # }
